...
const defaultOptions = {
    ...
    n: 3, //圆点数量：n*n
    innerRadius: 40, // 圆点的内半径
    outerRadius: 100, // 圆点的外半径，focus时显示
    touchRadius: 150, // 判定touch事件的圆半径
    render: true, // 自动渲染
    ...
    async record(){
        ...
        let handler = evt => {
            ...
            for(let i =0; i<this.circles.length; i++){
                ...
                if(distance(point, touchPoint) < touchRadius){
                    ...
                    console.log('touchmove records ', records);
                    break;
                }
            }
            // 画移动线段
        ...
        let promise = new Promise((resolve, reject) => {
            ...
            recordingTask.cancel = (res = {}) => {
                ...
                console.log('touchend records', records);
                moveCtx.clearRect(0, 0, moveCanvas.width, moveCanvas.height);
